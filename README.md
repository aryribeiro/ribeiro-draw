...
Fork independente do [Excalidraw](https://github.com/excalidraw/excalidraw), otimizado para diagramas de infraestrutura cloud: **974 ícones** (810 oficiais AWS + 164 de marcas, linguagens, redes e formas) e **interoperabilidade completa com o draw.io** — importa e exporta `.drawio`/`.xml` com fidelidade. Totalmente self-hosted, sem dependências de serviços externos.
...
| --- | --- | --- |
| Marcas & SaaS | 93 | GitHub, Vercel, Kiro, TOTVS, Microsiga Protheus, HubSpot, Dynamics 365, Zoho, Odoo, Sage, SAP HANA/S4HANA, Salesforce, Streamlit, Turso, Teams, WhatsApp, Meta, Instagram, TikTok, Kwai, Netflix, Windows Server, Active Directory, Kubernetes, Docker, Zendesk, Slack (colorido), Stripe, OpenAI, Anthropic, Rust, Go, Java, C/C++/C#, PHP, Ruby, Kotlin, Swift, Flutter, Angular, Laravel, Spring... |
...
| **Total** | **164** | carregado sob demanda (chunk separado) |
