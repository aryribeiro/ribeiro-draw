...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    plugins: [
      Sitemap({
        hostname: "https://ribeiro-draw.vercel.app",
        outDir: "build",
        changefreq: "monthly",
      ...
      VitePWA({
        ...
        workbox: {
          ...
          maximumFileSizeToCacheInBytes: 6 * 1024 ** 2, // 6MB (inclui ícones AWS inline)
        },
        manifest: {
          short_name: "Ribeiro Draw!",
          name: "Ribeiro Draw!",
          description:
            "Ribeiro Draw! is a whiteboard tool that lets you easily sketch diagrams that have a hand-drawn feel to them.",
          icons: [
            {
